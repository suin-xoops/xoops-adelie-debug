<?php require_once XOOPS_ROOT_PATH.'/class/logger.php';require_once XOOPS_ROOT_PATH.'/class/smarty/Smarty.class.php';define('ADELIE_DEBUG_BUILD', true); define('ADELIE_DEBUG_BUILD_TIME', 1320072925);
/**
...
}class AdelieDebug_Build_Config { public static $configs = array (
  'Config' => 
  array (
    'render.class' => 'AdelieDebug_Render_Smarty',
    'theme.name' => 'AdelieDebug',
  ),
  'Route' => 
  array (
    'route' => 
...
); }class AdelieDebug_Build_Template { public static $sources = array (
  'Template/Error/InternalServerError' => '<h1><{$statusMessage}></h1>
<pre><{$exception}></pre>
',
...
<div class="adelieDebug">
  ...
  'Template/Top/Index' => '<h1>AdelieDebug</h1>',
  'Theme/AdelieDebug/Main' => '<!DOCTYPE html>
<html lang="ja">
	<head>
		<meta charset="utf-8" />
